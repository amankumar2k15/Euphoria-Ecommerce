...
import productCartImg1 from "../../assets/multipleImg/productCartImg1.svg";
import productCartImg2 from "../../assets/multipleImg/productCartImg2.svg";
import productCartImg3 from "../../assets/multipleImg/productCartImg3.svg";
...
const Cart = () => {
    let cartItems = [
        { src: productCartImg1, productName: "Blue Flower Print Crop Top", color: "Yellow", size: "M", price: "$29.00", shipping: "FREE", subtotal: "$29.00", },
        { src: productCartImg3, productName: "Levender Hoodie", color: "Levender", size: "XXL", price: "$119.00", shipping: "FREE", subtotal: "$119.00", },
        { src: productCartImg2, productName: "Black Sweatshirt", color: "Black", size: "XXL", price: "$123.00", shipping: "$5.00", subtotal: "$123.00", },
    ];
        ...
        <>
                            ...
                            <div className="">
                                ...
                                <div className="w-max mx-4 ">
                                    <p className="  text-sm font-semibold  text-mediumBlack">
                                        Already registered?{" "}
                                        <Link to="/login" className="text-purpleColor cursor-pointer">Please login here</Link>
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            <div className="md:hidden block">
                ...
                {cartItems.map((item, index) => {
                    return (
                        <div key={index} className="md:flex py-8 md:py-10 lg:py-8 border-t border-black">
                            <div className="md:w-4/12 2xl:w-1/4 w-full">
                                <img src={item.src} alt="Black Leather Bag" className=" object-center md:block hidden w-3/6" />
                                <img src={item.src} alt="Black Leather Bag" className="md:hidden h-full object-center object-cover w-3/6 my-6 mx-8" />
                            </div>
            ...
            <div className="hidden md:block">
                <table className="w-full text-center text-md font-light">
                    <thead className="border-b bg-lightBlack font-medium text-white border-neutral-500 ">
                        <tr className="">
                            <th scope="col" className="font-semibold text-sm md:text-md lg:text-lg uppercase py-4">
                                Product Details
                            </th>
                            <th
                                scope="col"
